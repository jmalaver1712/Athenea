...
<?php
$Id_Capitulo = $_GET['Id'];
$consulta = $conexion->query("SELECT * FROM capitulo WHERE Id_Capitulo = '$Id_Capitulo' " )or die ("Error 1 ".$mysqli->error);
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<li class="pull-right"><a onclick="return confirmDelete(this);" <?php echo "href='../eliminar/eliminar.php?Id=".$row['Id_Capitulo']."&Tabla=capitulo&Campo=Id_Capitulo'"; ?> class="text-muted"><i class="fa fa-close"></i></a></li>
				<li class="pull-right"><a <?php echo "href='../edit/capitulo.php?Id=".$row['Id_Capitulo']."'" ?> class="text-muted"><i class="fa fa-edit"></i></a></li>
				</ul><br>
				
				<table border="0" width="80%">
					<tr>
					<tr>
						<td width="25%"><label>Título de Capítulo:</label></td>
					...
					<tr>
						<td><label>Nombre Par evaluador:</label></td>
