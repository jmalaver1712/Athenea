...
<?php 
$Id = $_GET['Id'];
$consulta = $conexion->query("SELECT * FROM capitulo WHERE Id_Capitulo = '$Id' " )or die ("Error 1 ".$mysqli->error);
				...
				<div class="row">
								...
								<form action="capitulophp.php" method="post" enctype="multipart/form-data" name="registro">
									<table border="0" width="80%">
										<tr>
											...
											<tr>
												<td width="25%"><label>*Titulo del Capítulo:</label></td>
												<input class="form-control" type="hidden" name="Id_Capitulo" value="<?php echo $Id; ?>" >
					...
					//Integrantes
													...
													<tr>
														...
														<td><input class="form-control" type="text" name="libro" value="<?php echo $row['Libro']; ?>" required ><br></td>
													</tr>
													...
													<tr>
														...
														<td><input class="form-control" type="text" name="Compilador" value="<?php echo $row['Compilador']; ?>"><br></td>
													</tr>

													<tr>
														<td>
															<label>Nombre del Par evaluador:</label>
														</td>
														<td><input class="form-control" type="text" name="Nombre_Par" value="<?php echo $row['Nombre_Par']; ?>"><br></td>
													</tr>
													...
													<tr>
														...
														<td><input class="form-control" type="number" name="pags" value="<?php echo $row['Pags']; ?>"><br></td>
													</tr>
													<tr>
														<td>
															<label>Ciudad:</label>
													...
													<tr>
														...
														<td><a href="<?php
															...
															if ($Tipo_Doc == "Documento"){
																echo "../documentos/capitulo/".$row['URL'];
															}
															else{
																echo $row['URL'];
															}
													...
													<table id="editdoc" >
														<tr>
															...
															<center><input class="btn btn-primary" type="submit" name="enviar" value="Guardar"></center>
														</form>
