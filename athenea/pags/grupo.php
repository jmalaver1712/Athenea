	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				$queryz = $conexion->query("SELECT * FROM grupos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Nombres ASC")or die($mysqli->error);
					...
					<div class="col-xs-12">
						<div class="box">
							...
							<form action="grupo.php" method="GET">
										...
										<tr>
											...
											<td valign="center">
												...
												<select class="form-control" name="Campo">
													...
													<option value="Creacion">Año de Creacion</option>
												</select>
											</td>
											<td valign="center">
								...
								<div id="consulta">
									<?php
									$query = "SELECT DISTINCT Rectoria FROM grupos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
									$Campo = "Rectoria";

									if(isset($_GET['Campo'])){
										$Campo = $_GET['Campo'];
										$query = "SELECT DISTINCT $Campo FROM grupos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
									}
									...
									while($row = $result->fetch_assoc()){
										...
										$query2 = "SELECT * FROM grupos WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
			...
			<table width="100%" id="example1" class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th width="25%">Investigador Lider</th>
						<th width="15%">Sede</th>
						<th width="30%">Lineas</th>
				...
				<tbody>
					...
					while ($row = $queryz->fetch_assoc()){
						...
						print ("<tr>
							<td><a href='../ver/grupo.php?Id=".$row['Id_Grupo']."'>$row[Nombres]</a></td>
