	...
	<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <?php				
				...
				$queryz = $conexion->query("SELECT * FROM articulo WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria ASC");
		...
		<section class="content">
          <div class="row">
			...
			<div id="consulta">
			<?php
			$query = "SELECT DISTINCT Rectoria FROM articulo  WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
			$Campo = "Rectoria";
			
			if(isset($_GET['Campo'])){
			$Campo = $_GET['Campo'];
			$query = "SELECT DISTINCT $Campo FROM articulo WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
			}
			...
			$numero = 0;
				...
				$query2 = "SELECT * FROM articulo WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
              ...
              <div class="box">
				...
				<?php				
					while ($row = $queryz->fetch_assoc()){
						print ("<tr>
						<td><a href='../ver/articulo.php?Id=".$row['Id_Articulo']."'>$row[Titulo]</a></td>
