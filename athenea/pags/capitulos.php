	...
	<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <?php				
				...
				$queryz = $conexion->query("SELECT * FROM capitulo WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria ASC");
		...
		<section class="content">
          <div class="row">
			...
			<div id="consulta">
			<?php
			$query = "SELECT DISTINCT Rectoria FROM capitulo  WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
			$Campo = "Rectoria";
			if(isset($_GET['Campo'])){
			$Campo = $_GET['Campo'];
			$query = "SELECT DISTINCT $Campo FROM capitulo WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
			}
			...
			$numero = 0;
				...
				$query2 = "SELECT * FROM capitulo WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
              ...
              <div class="box">
				...
				<?php				
					while ($row = $queryz->fetch_assoc()){
						print ("<tr>
						<td><a href='../ver/capitulo.php?Id=".$row['Id_Capitulo']."'>$row[Titulo]</a></td>
