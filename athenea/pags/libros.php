	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				$queryz = $conexion->query("SELECT * FROM libro WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria ASC");
					...
					<div class="col-xs-12">
						<div class="box">
							...
							<form action="libros.php" method="GET">
								...
								<div id="consulta">
									<?php
									$query = "SELECT DISTINCT Rectoria FROM libro  WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
									$Campo = "Rectoria";
									
									if(isset($_GET['Campo'])){
										$Campo = $_GET['Campo'];
										$query = "SELECT DISTINCT $Campo FROM libro WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
									}
									...
									while($row = $result->fetch_assoc()){
										...
										$query2 = "SELECT * FROM libro WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
			...
			<table id="example1" class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th width="20%">Sede</th>
						<th width="15%">Palabras Claves</th>
				...
				<tbody>
					...
					while ($row = $queryz->fetch_assoc()){
						print ("<tr>
							<td><a href='../ver/libro.php?Id=".$row['Id_Libro']."'>$row[Titulo]</a></td>
