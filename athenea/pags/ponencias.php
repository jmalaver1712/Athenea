	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				$queryz = $conexion->query("SELECT * FROM ponencia WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria ASC");
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<form action="ponencias.php" method="GET">
								<center>
									<br>
									<table width="80%">
										<tr>
								...
								<div id="consulta">
									<?php
									$query = "SELECT DISTINCT Rectoria FROM ponencia WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
									$Campo = "Rectoria";
									
									if(isset($_GET['Campo'])){
										$Campo = $_GET['Campo'];
										$query = "SELECT DISTINCT $Campo FROM ponencia WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
									}
									...
									while($row = $result->fetch_assoc()){
										...
										$query2 = "SELECT * FROM ponencia WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					while ($row = $queryz->fetch_assoc()){
						...
						print ("<tr>
							<td><a href='../ver/ponencia.php?Id=".$row['Id_Ponencia']."'>$row[Titulo]</a></td>
							<td>$row[Nombres_Inves]</td>
							<td>$row[Evento]</td>
							<td>$row[Fecha]</td>
							<td>$row[$Campo]</td>
						</tr>");
