	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				$queryz = $conexion->query("SELECT * FROM proyectos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Nombre ASC");
					...
					<div class="col-xs-12">
						<div class="box">
							...
							<form action="proyecto.php" method="GET">
								...
								<div id="consulta">
									<?php
									$query = "SELECT DISTINCT Rectoria FROM proyectos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY Rectoria DESC";
									$Campo = "Rectoria";
									
									if(isset($_GET['Campo'])){
										$Campo = $_GET['Campo'];
										$query = "SELECT DISTINCT $Campo FROM proyectos WHERE Rectoria LIKE '%$Rectoria%' ORDER BY $Campo DESC";
									}
									...
									while($row = $result->fetch_assoc()){
										...
										$query2 = "SELECT * FROM proyectos WHERE $Campo = '$categoria[$c]' AND Rectoria LIKE '%$Rectoria%' ";
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					while ($row = $queryz->fetch_assoc()){
						print ("<tr>
							<td><a href='../ver/proyecto.php?Id=".$row['Id_Proyecto']."'>$row[Nombre]</a></td>
							<td><a href='../ver/investigador.php?Id=".$row['Id_Investigador']."'>$row[Nombre_Lider]</a></td>
