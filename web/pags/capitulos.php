    ...
    <!--breadcrumbs end-->
     <?php
						...
						if(isset($_GET['Criterio']) && isset($_GET['Campo'])){
							...
							$consulta = "SELECT * FROM capitulo WHERE $Campo LIKE '%$Criterio%'";
						}
        ...
        <div class="col-lg-9 ">
          <div class="blog-item">
             <table class="ui celled striped table">
                            <thead>
                                <tr>
                                    <th width="30%" colspan="4"> Capítulos</th>
                                </tr>
                            </thead>
                            <tbody>
								<?php
									...
									//Limito la busqueda
										...
										while ($row2= $rs->fetch_assoc()){
											...
											print("<b>Título:</b><br>
												<p align='justify'>".$row2['Titulo']."<br>
												<br><b>Libro:</b><br><p align='justify'>".$row2['Libro']."<br>
												<br><b>Año: </b>".$row2['Ano']."</td>
												</tr>
											");
										}
								?>
