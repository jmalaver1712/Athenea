...
<html lang="en">
  ...
  <body>
    ...
    <!--breadcrumbs end-->
      <?php
						$consulta = "SELECT * FROM ponencia";
						$Campo = "Titulo";
						$Criterio = "a";
						if(isset($_GET['Criterio']) && isset($_GET['Campo'])){
							$Campo = $_GET['Campo'];
							$Criterio = $_GET['Criterio'];
							$consulta = "SELECT * FROM ponencia WHERE $Campo LIKE '%$Criterio%'";
						}
        ...
        <div class="col-lg-9 ">
          <div class="blog-item">
           ...
           <table class="ui celled striped table">
                            <thead>
                                <tr>
                                    <th width="30%" colspan="4"> Ponencias</th>
                                </tr>
                            </thead>
                            <tbody>
								<?php
									...
									if ($num_total_registros > 0) {
										...
										print("<b>Título: </b><br><p align='justify'>".$row['Titulo']."
											<br><br><b>Evento:</b><br>".$row['Evento']."</p></td></tr>
										");
									}
								?>
                            </tbody>
