...
<html lang="en">
  ...
  <body>
    ...
    <!--breadcrumbs end-->
      <?php
            $consulta = "SELECT * FROM proyectos WHERE Rectoria LIKE '%$NRec%'";
            $Campo = "Nombres_Inves";
            $Criterio = "a";
            if(isset($_GET['Criterio']) && isset($_GET['Campo'])){
                $Campo = $_GET['Campo'];
                $Criterio = $_GET['Criterio'];
                $consulta = "SELECT * FROM proyectos WHERE $Campo LIKE '%$Criterio%'";
            }
           ...
           <?php
				                ...
				                if ($num_total_registros > 0) {
				                    ...
				                    while ($row = $rs->fetch_assoc()){
				                        ...
				                        print("<tr>
											<td><h2>".$row['Nombre']."</h2><br>
				                        ");
                                        $integ = $row['Nombres_Inves'];
				                        ...
				                        //}
				                        print("
                                            <br><b>Descripción: </b><br><p style='text-align:justify'>".$row['Descripcion']."</p></td>
                                            </tr>
				                        ");
                                    }
				                ?>
